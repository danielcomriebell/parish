...
var Press = angular.module('myApp.Press', ['ngRoute', 'ngAnimate', 'ngResource',
  'ngTouch',
  'myApp.Routes',
  'myApp.Services'
])
...
Press.controller('pressCtrl', ['$scope', '$timeout', '$rootScope', '$routeParams', '$http', '$window', '$q', '$location','cfpLoadingBar', function ($scope, $timeout, $rootScope, $routeParams, $http, $window, $q, $location, cfpLoadingBar){


$rootScope.isPage = "page-press";
...
// Access Token: 371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59
//
//
// cfpLoadingBar.start();
// cfpLoadingBar.set(2) // Set the loading bar to 30%
...
//..............................................................................the GET request
	...
	var endpoint = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&callback=JSON_CALLBACK";
				$http({url: endpoint, method: 'JSONP', cache: true, isArray: true}).success(function(response){
						// callback(response);
							...
							var endpoint1 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_0 + "&callback=JSON_CALLBACK";
                            ...
                            $scope.hideLoadMore = false;
														...
														var endpoint2 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_1 + "&callback=JSON_CALLBACK";
																		...
																		var endpoint3 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_2 + "&callback=JSON_CALLBACK";
																						...
																						$http({url: endpoint3, method: 'JSONP', cache: true, isArray: true}).success(function(response){
																									...
																									var endpoint4 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_3 + "&callback=JSON_CALLBACK";
																													...
																													$http({url: endpoint4, method: 'JSONP', cache: true, isArray: true}).success(function(response){
																																...
																																var endpoint5 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_4 + "&callback=JSON_CALLBACK";
																																				...
																																				$http({url: endpoint5, method: 'JSONP', cache: true, isArray: true}).success(function(response){
																																							...
																																							var endpoint6 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_5 + "&callback=JSON_CALLBACK";
																																											...
																																											$http({url: endpoint6, method: 'JSONP', cache: true, isArray: true}).success(function(response){
																																														...
																																														var endpoint7 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_6 + "&callback=JSON_CALLBACK";
																																																		...
																																																		$http({url: endpoint7, method: 'JSONP', cache: true, isArray: true}).success(function(response){
																																																					...
																																																					var endpoint8 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_7 + "&callback=JSON_CALLBACK";
																																																									...
																																																									$http({url: endpoint8, method: 'JSONP', cache: true, isArray: true}).success(function(response){
																																																												...
																																																												var endpoint9 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_8 + "&callback=JSON_CALLBACK";
																																																																...
																																																																$http({url: endpoint9, method: 'JSONP', cache: true, isArray: true}).success(function(response){
																																																																			...
																																																																			var endpoint10 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_9 + "&callback=JSON_CALLBACK";
																																																																							...
																																																																							$http({url: endpoint10, method: 'JSONP', cache: true, isArray: true}).success(function(response){
																																																																										...
																																																																										var endpoint11 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_10 + "&callback=JSON_CALLBACK";
																																																																														...
																																																																														$http({url: endpoint11, method: 'JSONP', cache: true, isArray: true}).success(function(response){
																																																																																	...
																																																																																	var endpoint12 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_11 + "&callback=JSON_CALLBACK";
																																																																																					...
																																																																																					$http({url: endpoint12, method: 'JSONP', cache: true, isArray: true}).success(function(response){
																																																																																								...
																																																																																								var endpoint13 = "https://api.instagram.com/v1/users/371330907/media/recent?access_token=371330907.984dc1b.1d88f5b1f59c4f76a91dff80cc6ace59&max_id=" + maxID_12 + "&callback=JSON_CALLBACK";
...
//
	...
	$scope.pressMobileLocation = function(url){
		$location.path(url).search();
	}

	$scope.pressMobileOutsideViewOnInstagram = function(index){

		$window.open($scope.instaTotal[index].link, '_blank');
	}

	$scope.pressMobileOutsideReadFullStory = function(){
...
Press.directive('instaimageclickDirective', function(){
	return {
		restrict: 'A',
...
Press.directive('instaHoverDirective', function($location, $routeParams){
  return{
    restrict: "A",
    link: function(scope, element, attrs){
...
Press.directive('instaCloseDirective', function($window){
  return{
    restrict: "E",
    replace: 'true',
...
Press.directive('instaShareDirective', function($routeParams){
	  return{
	    restrict: "E",
	    replace: true,
...
Press.directive('onFinishRender', function ($timeout) {
	return {
	    restrict: 'A',
...
Press.directive('filterActiveDirective', function ($timeout) {
			return {
			    restrict: 'A',
			    link: function (scope, element, attr) {
...
Press.directive('pressStyleParent', function(){
   return {
     restrict: 'A',
...
//
// Press.directive('journalDetailStyleParent', function(){
//    return {
//      restrict: 'A',
//      link: function(scope, elem, attr) {
//
